  ...
  try {
    ...
    return (
      <div className="mx-auto max-w-3xl px-8 py-10">
        <h1 className="text-lg font-medium text-text-primary">Pagos</h1>
    ...
    <div className="mx-auto max-w-3xl px-8 py-10">
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          ...
          <h1 className="mt-1 text-lg font-medium text-text-primary">Pagos</h1>
          <p className="mt-1 max-w-md text-sm text-text-secondary">{contract.object}</p>
        </div>
        <Link
          href={`/contratos/${contract.id}/pagos/nuevo`}
      ...
      <ContractSubnav contractId={contract.id} active="pagos" />

      {payments.length === 0 ? (
        <div className="rounded-lg border border-dashed border-border px-6 py-12 text-center">
          <p className="text-sm text-text-secondary">Aún no hay pagos registrados.</p>
          <Link
            href={`/contratos/${contract.id}/pagos/nuevo`}
